...
#     ::nsrpc::stop at server shutdown. Returns 1 or error.
#
...
proc ::nsrpc::send {server command responseArrayName {args ""}} {
    ...
    $curlhandle configure -tcpnodelay 1 -verbose 1 
    $curlhandle configure -debugproc ::wsa::rpc::curldebug
...
# Arguments:
#     -detached (optional): 
#         Execues the call in a detached thread that can not be waited on.
#     args: 
#         See ::nsrpc::call   
#
# Results:
...
proc ::nsrpc::curldebug {infoType data} {
    ns_log debug "RPC debug: ${infoType}: [string trim $data \n]"
}
